...
/*--------------------------------------------*/
$category_list = IDOCS_Taxanomies::get_root_categories_terms_caching($kb_id, 0, $hide_empty_categories, $category_cards_order_by );
/*--------------------------------------------*/
...
?>	
    ...
    <div class="row gx-<?php echo esc_attr($spacing_between_cards);?> mb-3 justify-content-center">
        ...
        if ($row_index == ($required_rows-1)) {
            ...
            //do_action( 'qm/debug', $max_in_a_row );
